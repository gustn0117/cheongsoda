      ...
      <div className="container-px mx-auto max-w-7xl pt-24 pb-14 sm:pt-40 sm:pb-28 lg:pt-48 lg:pb-36">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:gap-16 lg:items-center">
          <div className="animate-fade-up">
            ...
            <p className="mt-4 text-sm font-bold tracking-[0.04em] text-[#7DA0FF] sm:mt-6 sm:text-lg break-keep">
              입주 · 이사 · 거주 · 상가청소 전문
            </p>

            <h1 className="heading-display mt-2 text-[2.15rem] sm:text-6xl lg:text-7xl break-keep">
            ...
            <div className="mt-6 grid grid-cols-1 gap-2 sm:mt-9 sm:flex sm:flex-wrap sm:items-center sm:gap-3">
              <a
                href={COMPANY.kakao}
                target="_blank"
                rel="noreferrer"
            ...
            <div className="mt-7 grid grid-cols-2 gap-2 max-w-lg sm:mt-12 sm:grid-cols-4 sm:gap-3">
              {[
                ...
                <div
                  key={s.l}
                  className="rounded-2xl border border-white/15 bg-white/5 px-3 py-2.5 backdrop-blur sm:px-4 sm:py-3"
                >
                  <div className="number-tabular text-base font-extrabold text-white sm:text-xl">{s.v}</div>
          ...
          <div className="animate-fade-up [animation-delay:120ms]">
            <div className="relative rounded-3xl border border-white/20 bg-white/[0.08] p-5 shadow-navy-lg backdrop-blur-xl sm:p-8">
              <div className="absolute -top-3 left-5 rounded-full bg-[#FEE500] px-3 py-1 text-[11px] font-extrabold text-[#3C1E1E] shadow-soft sm:left-6 sm:text-xs">
                30초 견적 신청
              </div>
              <h3 className="heading-section text-[1.4rem] text-white sm:text-3xl break-keep">
                지역별 맞춤 청소견적!
                <br />
              ...
              <p className="mt-2 text-[13px] text-white/75 break-keep sm:text-sm">
              ...
              <ul className="mt-4 space-y-2 sm:mt-6 sm:space-y-3">
                {[
                  ...
                  <li key={t} className="flex items-start gap-2 text-[13px] text-white/90 break-keep sm:text-sm">
              ...
              <a
                href="#contact"
                onClick={jumpToQuote}
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-2xl bg-white py-3.5 text-base font-bold text-navy-700 transition hover:bg-navy-50 sm:mt-6 sm:py-4"
              >
                무료 견적 받기
                <ArrowRight size={16} />
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-2 flex w-full items-center justify-center gap-2 rounded-2xl border border-white/30 bg-white/5 py-2.5 text-sm font-semibold text-white transition hover:bg-white/15 sm:mt-2.5 sm:py-3"
              >
                <KakaoBubble size={14} />
                카카오톡 채널 바로가기
              </a>
